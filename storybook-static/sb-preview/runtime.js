...
var Vt = y((ps, xn) => {
  ;(function (r) {
    ...
    return /* @__PURE__ */ n(function o(a, i, s) {
      ...
      n(c, 's')
      for (var l = typeof Mr == 'function' && Mr, u = 0; u < s.length; u++)
        c(s[u])
      return c
    }, 'e')(
      {
          ...
          function (o, a, i) {
            ...
            function l(p) {
              ...
              for (
                ...
                m >= 0 &&
                ((d = p[m]), (g = d.cacheItem.get(d.arg)), !g || !g.size);
                m--
              )
...
var Pd = y((XL, _d) => {
  ...
  function q_(r, e, t) {
    return (
      ...
      function () {
        for (
          var o = arguments, a = -1, i = xd(o.length - e, 0), s = Array(i);
          ++a < i;
...
: '
  ...
  function Fi(r) {
    return (
      Pe(r) === '[object Array]' && (!X || !(typeof r == 'object' && X in r))
    )
  }
  n(Fi, 'isArray')
  function yC(r) {
    return (
      Pe(r) === '[object Date]' && (!X || !(typeof r == 'object' && X in r))
    )
  }
  n(yC, 'isDate')
  function eh(r) {
    return (
      Pe(r) === '[object RegExp]' && (!X || !(typeof r == 'object' && X in r))
    )
  }
  n(eh, 'isRegExp')
  function hC(r) {
    return (
      Pe(r) === '[object Error]' && (!X || !(typeof r == 'object' && X in r))
    )
  }
  n(hC, 'isError')
  function mC(r) {
    return (
      Pe(r) === '[object String]' && (!X || !(typeof r == 'object' && X in r))
    )
  }
  n(mC, 'isString')
  function gC(r) {
    return (
      Pe(r) === '[object Number]' && (!X || !(typeof r == 'object' && X in r))
    )
  }
  n(gC, 'isNumber')
  function SC(r) {
    return (
      Pe(r) === '[object Boolean]' && (!X || !(typeof r == 'object' && X in r))
    )
  }
  n(SC, 'isBoolean')
  function ah(r) {
  ...
  var VC = Bo(),
    ...
    KC = /* @__PURE__ */ n(function (e, t, o, a, i) {
      ...
      for (var c = '', l = 0; l < s.length; l += Gi) {
        for (
          var u = s.length >= Gi ? s.slice(l, l + Gi) : s, p = [], h = 0;
          h < u.length;
          ++h
        ) {
      ...
      return {
        ...
        allowPrototypes:
          typeof e.allowPrototypes == 'boolean'
            ...
            : U.allowPrototypes,
        allowSparse:
          typeof e.allowSparse == 'boolean' ? e.allowSparse : U.allowSparse,
        arrayLimit:
          typeof e.arrayLimit == 'number' ? e.arrayLimit : U.arrayLimit,
        charset: t,
        charsetSentinel:
          typeof e.charsetSentinel == 'boolean'
            ? e.charsetSentinel
        ...
        depth:
          typeof e.depth == 'number' || e.depth === !1 ? +e.depth : U.depth,
        duplicates: o,
        ...
        plainObjects:
          typeof e.plainObjects == 'boolean' ? e.plainObjects : U.plainObjects,
        strictNullHandling:
          typeof e.strictNullHandling == 'boolean'
            ? e.strictNullHandling
...
var Qi = y((te) => {
  ...
  function Wo(r) {
    return (
      '&#x' +
      (r.length > 1 ? MI(r) : r.charCodeAt(0)).toString(16).toUpperCase() +
      ';'
    )
  }
          ...
          value: /* @__PURE__ */ n(function (t) {
            ...
            return (
              ...
              rF(t.join(''), i, function (c, l) {
                var u = em(a, c, l, i)
                u && s.push(u),
                  i.stream && (o.stickyStack = tF(o.stickyStack, c, l))
              }),
        ...
        for (var qt = 1, Lr = !0; qt < N.length; qt += 1) {
          ...
          if (
            ...
            if (c && qt + 1 >= N.length) {
              var kt = c(z, de)
              ;(Lr = !!kt),
                Lr && 'get' in kt && !('originalValue' in kt.get)
                  ? (z = kt.get)
                  : (z = z[de])
  ...
  Ln = class Ln {
    ...
    getCurrentFrames() {
      return this.config.page === 'manager'
        ? Array.from(Nn.querySelectorAll('[data-is-storybook="true"]')).flatMap(
    ...
    getLocalFrame() {
      return this.config.page === 'manager'
        ? Array.from(Nn.querySelectorAll('#storybook-preview-iframe')).flatMap(
            (t) => (t.contentWindow ? [t.contentWindow] : [])
          )
        : A && A.parent
          ? [A.parent]
      ...
      `),
        ...
        let u = s ? `${o}[${c}]` : o,
          p = a
            ...
            .join(', ')
        return (
          k.warn(`Received illegal value for '${u}'. Supported options: ${p}`),
          t
        )
      }, {}),
    'validateOptions'
      ...
      `),
        ...
        : (t.add(r),
          Array.isArray(r)
            ...
            : {
                name: 'object',
                value: (0, wo.default)(r, (i) => ni(i, e, new Set(t))),
              })
      : {
          name: 'objec\
t',
...
var gi = class gi extends He {
  ...
  async onUpdateGlobals({ globals: t }) {
    let o =
      (this.currentRender instanceof Ue && this.currentRender.story) || void 0
...
function sF() {
  return (
    is || (is = new gm.default(A.navigator?.userAgent).getBrowserInfo()), is
  )
}
n(sF, 'getBrowserInfo')
function Sm(r) {
